...
from probes.intervention_ops import ablate_to_target, diff_of_means_direction, find_subsequence, mean_projection, probe_logit, random_unit_direction, raw_unit_direction
...
def test_random_direction_barely_moves_probe_logit():
    ...
    ablated_random = ablate_to_target(h, r, target_proj=mean_projection(rng.standard_normal((20, 64)), r))
